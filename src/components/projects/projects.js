    ...
    return (
        <section id="projects">
            ...
            <div className="projects-imgs">
                <a href="https://xchen601.github.io/Fashion-App/" target="_blank"><img src={Portfolio1} className="projects-img" alt="perfect fit project"/></a>
                <a href="saliftankoano.github.io/simon-game/" target="_blank"><img src={Portfolio2} className="projects-img" alt="simon game"/></a>
                <a href="https://saliftankoano.github.io/meme-parlor/" target="_blank"><img src={Portfolio3} className="projects-img" alt=""/></a>
            </div>
